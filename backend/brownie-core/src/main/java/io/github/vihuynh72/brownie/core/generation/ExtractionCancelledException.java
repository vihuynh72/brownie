...
public class ExtractionCancelledException extends Exception {

    public ExtractionCancelledException() {
        super("Extraction was cancelled before its next model call.");
    }
}
